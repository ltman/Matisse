...
public class BditMediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private BditCheckView mCheckView;
    ...
    public BditMediaGrid(Context context) {
        super(context);
        init(context);
    }

    public BditMediaGrid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public interface OnMediaGridClickListener {
        ...
        void onCheckViewClicked(BditCheckView checkView, Item item, RecyclerView.ViewHolder holder);
    }
