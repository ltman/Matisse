...
public class BditAlbumMediaAdapter extends
        ...
        BditMediaGrid.OnMediaGridClickListener {
    ...
    public BditAlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView) {
        super(null);
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof MediaViewHolder) {
            ...
            mediaViewHolder.mMediaGrid.preBindMedia(new BditMediaGrid.PreBindInfo(
    ...
    private void setCheckStatus(Item item, BditMediaGrid mediaGrid) {
    ...
    @Override
    public void onCheckViewClicked(BditCheckView checkView, Item item, RecyclerView.ViewHolder holder) {
        updateSelectedItem(item, holder);
    }
    ...
    private static class MediaViewHolder extends RecyclerView.ViewHolder {
        ...
        private BditMediaGrid mMediaGrid;

        MediaViewHolder(View itemView) {
            super(itemView);
            mMediaGrid = (BditMediaGrid) itemView;
        }
    }
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View itemView) {
            ...
            mHint = (ImageView) itemView.findViewById(R.id.hint);
        }
    }
